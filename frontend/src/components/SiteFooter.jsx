...
export default function SiteFooter() {
  return (
    <footer className="mt-24 border-t text-white" style={{ background: "var(--navy)", borderColor: "rgba(15,23,42,0.08)" }}>
      ...
      <div className="mx-auto grid w-[min(1180px,calc(100%-40px))] gap-12 py-16 md:grid-cols-3">
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-white/75">
            ...
            <li><Link to="/events" className="hover:text-[var(--gold)]">Events</Link></li>
        ...
        <div>
          ...
          <ul className="mt-4 flex gap-4">
            <li>
              <a href="https://www.linkedin.com/company/south-african-chamber-of-commerce-singapore/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-white/75 hover:border-[var(--gold)] hover:text-[var(--gold)]">
            ...
            <li>
              <a href="http://www.youtube.com/@southafricanchamberofcomme1837" target="_blank" rel="noopener noreferrer" aria-label="YouTube"
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-white/75 hover:border-[var(--gold)] hover:text-[var(--gold)]">
